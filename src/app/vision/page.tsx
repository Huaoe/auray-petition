...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez les fondements et la vision de notre démarche pour une laïcité pleine et entière.",
};
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 max-w-4xl pt-16 pb-12 sm:pt-24 sm:pb-20 text-center">
            ...
            <p className="mt-6 text-xl sm:text-2xl text-gray-700 dark:text-gray-200 font-medium max-w-2xl mx-auto">
              Pour une République laïque, joyeuse, et résolument tournée vers
              l’avenir.
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 max-w-5xl py-8 sm:py-12 grid md:grid-cols-3 gap-8">
              ...
              <span className="mb-3 inline-flex items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-700/40 w-14 h-14 group-hover:bg-indigo-200 dark:group-hover:bg-indigo-600/50 transition-colors">
                ...
                >
                  <path
                    stroke="currentColor"
                    strokeWidth="2"
                    d="M12 20V8M5 12l7-7 7 7"
                  />
                </svg>
              </span>
              <h3 className="font-bold text-lg mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors">
                Liberté de conscience
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                L'émancipation individuelle est le socle d'une société moderne,
                où chacun peut croire ou ne pas croire sans pression ni
                privilège.
              </p>
            </div>
          </Link>
          <Link href="/vision/equalite-republicaine" className="group">
            <div className="bg-white/80 dark:bg-gray-900/70 rounded-2xl shadow-lg p-6 flex flex-col items-center text-center border-t-4 border-orange-400 hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
              ...
              <h3 className="font-bold text-lg mb-2 group-hover:text-orange-600 dark:group-hover:text-orange-300 transition-colors">
                Égalité républicaine
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Aucune communauté ne doit bénéficier de privilèges hérités du
                passé, tous les citoyens contribuent équitablement à la vie
                publique.
              </p>
            </div>
          </Link>
              ...
              <span className="mb-3 inline-flex items-center justify-center rounded-full bg-green-100 dark:bg-green-700/40 w-14 h-14 group-hover:bg-green-200 dark:group-hover:bg-green-600/50 transition-colors">
                ...
                >
                  ...
                  <path
                    stroke="currentColor"
                    strokeWidth="2"
                    d="M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v2"
                  />
                </svg>
              </span>
              <h3 className="font-bold text-lg mb-2 group-hover:text-green-600 dark:group-hover:text-green-300 transition-colors">
                Patrimoine vivant
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Réinventer nos églises : de simples reliques à des espaces de
                création, de culture et de partage ouverts à tous.
              </p>
            </div>
          </Link>
        </section>
        ...
        <section className="container mx-auto px-4 max-w-4xl py-12 sm:py-16">
          <article className="prose prose-lg dark:prose-invert mx-auto space-y-12">
            <section>
              ...
              <p>
                La <strong>loi de 1905</strong> a créé une distinction
                artificielle :
              </p>
              <ul>
                <li>
                  <strong>Édifices antérieurs à 1905 :</strong> propriété
                  publique (communes/État) →{" "}
                  <strong>entretien public obligatoire</strong>
                </li>
                <li>
                  <strong>Édifices postérieurs à 1905 :</strong> propriété
                  diocésaine → entretien privé
                </li>
              </ul>
              <blockquote className="border-l-4 border-yellow-500 pl-4 italic">
                Ceci est en <strong>contradiction flagrante</strong> avec
            ...
            <section>
              ...
              <ol>
                <li>
                  <strong>Violation du principe démocratique :</strong> Une
                  majorité laïque (56%) finance une minorité religieuse (1,5%
                  pratiquants).
                </li>
                <li>
                  <strong>Contradiction avec l'évolution sociétale :</strong>{" "}
                  Maintien d'un privilège historique catholique dans une France
                  devenue majoritairement non-croyante.
                </li>
                <li>
                  <strong>Inégalité entre cultes :</strong> Seul le catholicisme
                  bénéficie de ce financement public massif, les autres
                  religions finançant entièrement leurs lieux de culte.
                </li>
                <li>
                  <strong>Anachronisme juridique :</strong> Une loi de 1905
                  maintient artificiellement des privilèges dans une société qui
                  a radicalement évolué.
                </li>
              </ol>
              <p className="mt-4 font-semibold">
                Cette anomalie constitue l'une des dernières survivances du
                pouvoir clérical dans la République laïque et doit être
                questionnée au nom de l'égalité républicaine.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                La France de 2025 a <strong>radicalement changé</strong> :{" "}
                <strong>56% de non-croyants</strong> constituent désormais la{" "}
                <strong>majorité culturelle</strong> face à{" "}
                <strong>1,5% de catholiques pratiquants</strong>. Cette
                révolution silencieuse marque la fin définitive de quinze
                siècles de domination chrétienne.
              </p>
              <ul>
                <li>
                  <strong>L'oppression sonore</strong> des cloches imposées par
                  une minorité religieuse.
                </li>
                <li>
                  <strong>Le financement forcé</strong> de 40 307 églises par
                  leurs impôts.
                </li>
                <li>
                  <strong>Les privilèges anachroniques</strong> d'une religion
                  qu'ils ont librement rejetée.
                </li>
                <li>
                  <strong>L'imposition de rythmes religieux</strong> dans
                  l'espace public laïque.
                </li>
              </ul>
              <p className="mt-4 font-medium">
                La laïcité n'est plus une tolérance accordée aux religions, mais
                l'expression légitime d'une société émancipée qui a choisi la{" "}
                <strong>raison</strong> contre le <strong>dogme</strong>, la{" "}
                <strong>liberté de conscience</strong> contre l'
                <strong>autoritarisme clérical</strong>, et l'
                <strong>égalité républicaine</strong> contre les{" "}
                <strong>privilèges confessionnels</strong>.
              </p>
            </section>
          </article>
        </section>
