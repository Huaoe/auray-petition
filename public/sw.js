...
self.addEventListener("fetch", (event) => {
  ...
  // Bypass pour Unsplash - laisser le navigateur gérer directement pour éviter les erreurs CSP
...
console.log(
  "🎯 Service Worker Auray Pétition: Prêt à révolutionner la démocratie !"
);
